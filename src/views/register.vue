...
<!--                    <div>-->
<!--                      <span class="addFlex"><label>邮箱</label><span :class=" isEmail ? 'addColorGreen' : 'addColorRed' ">{{ emailInfo }}</span></span>-->
<!--                      <span><input name="" @blur="verifyEmail" ref="email" type="text" class="textbox" ></span>-->
<!--                    </div>-->
                    <div>
